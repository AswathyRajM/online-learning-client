  ...
  return (
    <div className='flex flex-col-reverse transition-all delay-100 md:flex-row rounded-xl overflow-hidden relative md:gap-x-10'>
      <div className='md:w-[70%] w-[100%] bg-white h-[fit] rounded-xl p-4 shadow-xl'>
        <h1>
          The Complete Python Bootcamp From Zero to Hero in PythonPythonPython
        ...
        <div>
          ...
          <p>
            Learn Python like a Professional Start from trounded-xl shadow-xlhe
            basics and go all the way to creating your own applications and ok
            games Learn Python like a Professional Start from the basics and go
            allrounded-xl shadow-xl the way to creating your own applications
            and dgames Learn Python like a Professional Start from the basics
            and go all the way to creating your own applications and games Learn
            vsm s dsdPython like a Professional Start from the basics and go all
            the way to creating your own applications and gamesrounded-xl
            shadow-xl
          </p>
        </div>
        <div>
